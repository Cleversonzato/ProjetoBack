...
class PerfilPublicoService @Inject()(implicit ec: ExecutionContext, reactiveMongoApi: ReactiveMongoApi, mongoDef: MongoIndexes ) extends CRUDService[PerfilPublico] {
